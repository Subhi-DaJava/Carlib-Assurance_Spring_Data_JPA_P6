...
--
-- Host: localhost    Database: carlib
-- ------------------------------------------------------
...
INSERT INTO `categorie` VALUES (1,'Standard'),(2,'Special'),(3,'JeunesConducteurs'),(4,'Promotion'),(10,'Assurance25'),(11,'Pour les -30 ans'),(15,'CatégorieTest');
...
INSERT INTO `categorie_produit` VALUES (1,1),(1,2),(1,3),(3,4),(4,5),(10,10),(11,11),(15,15);
...
INSERT INTO `commentaire` VALUES (1,'Assurance avec un bon rapport qualité prix',2),(2,'Minimum du minimum, un peu déçu',1),(3,'Ce qu\'on peut attendre d\'une assurance au tiers, ni plus, ni moins',1),(4,'Excellente assurance tous risques ! Prix compétitif vis à vis des autres assureurs',3),(5,'L\'assurance est bien, mais les délais de traitement ne me conviennent pas, trop d\'attente!',3),(6,'Il est super pour les jeunes conducteur',5),(8,'Ce commentaire sera supprimer dès après le test',15);
...
-- Dump completed on 2022-05-09 23:05:15
